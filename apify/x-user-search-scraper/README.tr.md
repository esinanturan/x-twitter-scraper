...
Twitter hesaplarını isme, konuya, biyografiye veya konuma göre ara. X API
anahtarı gerekmez.

- Kitleyi, gönderileri, yaşı, doğrulamayı, web sitesini, konumu, biyografiyi
  ve kullanıcı adını filtrele.
- Bir sorguya kaydedilen bir imleçten devam et. Göçler kabul edilen işi korur.
...
Her satır, `sourceTarget` içinde bir profil ve onun kaynaklandığı sorguyu
içerir.

## Fiyatlandırma

Her planda **teslim edilen profil başına $0.00015** ücret alınır. Apify,
platform kullanımını ayrıca faturalandırır.

- Teslim edilen veri satırı başına bir ücret. Tanılamalar `diagnostics`
  içinde ücretsizdir.
- Başlangıç, sorgu veya sayfa ücreti yok. Filtreler ve tekilleştirme
  faturalamadan önce çalışır.

50 herkese açık görevden seç. 129 REST işlemi örnek değerler ve canlı veri
kullanır.
