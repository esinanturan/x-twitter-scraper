...
Mélangez ressources et Communities en un seul run. Aucune clé API X ni
connexion requise.

## Données de Community et filtres

- Métadonnées et règles de la Community, quand X les expose.
- Derniers posts de la Community.
- Recherche par mot-clé avec tri Latest ou Top.
- Membres et modérateurs de la Community.
- Les filtres de post, de membre et de modérateur s'exécutent avant la
  facturation.
...
- Une facturation par ligne de donnée livrée. Les diagnostics sont gratuits
  dans `diagnostics`.
- Aucun frais de démarrage, de Community, de ressource ou de requête.
