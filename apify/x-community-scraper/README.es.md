...
Comunidad. Combina recursos y Comunidades en una sola ejecución. No requiere
clave de API de X ni inicio de sesión.

## Datos y filtros de Comunidad

- Metadatos y reglas de la Comunidad cuando X los expone.
- Publicaciones más recientes de la Comunidad.
- Búsqueda por palabra clave con ordenamiento por más recientes o
  destacados.
- Miembros y moderadores de la Comunidad.
- Los filtros de publicaciones, miembros y moderadores se ejecutan antes de
  facturar.
...
- Un cargo por cada fila de datos entregada. Los diagnósticos son gratuitos
  en `diagnostics`.
- Sin tarifa de inicio, de Comunidad, de recurso ni de consulta.
