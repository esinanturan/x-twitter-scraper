...
`communityModerator` のいずれかを使用します。すべての行には、入力コミュニティを示す `sourceTarget` が含まれます。ソースのフィールドは、値を創作することなくそのまま保持されます。
...
Xが公開している公開コミュニティのみ取得できます。利用可能なフィールドはコミュニティによって異なります。
