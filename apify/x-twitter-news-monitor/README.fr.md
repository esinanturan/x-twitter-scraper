...
monde, avec les données X les plus complètes. X (Twitter) News Monitor trie les
posts d'actualité par format, attribution de source et pertinence. Tous les
...
avait. `changes` liste chaque décision de format, d'attribution ou de pertinence
