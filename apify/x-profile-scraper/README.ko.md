...
- 자기소개, 개수, 인증, 소유자가 입력한 위치, 웹사이트, 미디어를 추출합니다.
...
대상 1개면 충분합니다. 전체 `maxItems` 상한에는 프로필과 선택한 리소스가 함께
포함됩니다.
...
독립적인 대상은 동시에 실행됩니다. 타임라인은 모든 필터와 함께 자동 커버리지를
사용합니다. 승인된 행, 과금 상태, 지문은 마이그레이션을 견뎌냅니다.
